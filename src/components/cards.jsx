...
function Cards()
{
    ...
    const cardnames = ["vegetables","personalcare","packagedfoods","cleaningproducts","fruits","staples"];
    const click = (a) =>{
    navigate("/"+a);    
       }
    return(
        <section className="cardshome">
         <div className = "row">
            <div className="col-lg-2 col-md-4 col-sm-6 colelement">
         ...
         <div className="col-lg-2 col-md-4 col-sm-6 colelement">
          <img className = "cardimg"  src={img5} onClick = {()=>click(cardnames[4])} alt="pic"/>
          <p className="cardtext">Fruits</p>
         </div>
         <div className="col-lg-2 col-md-4 col-sm-6 colelement">
          <img className = "cardimg"  src={img3} onClick = {()=>click(cardnames[2])} alt="pic"/>
          <p className="cardtext">Packaged Food</p>
         </div>
         <div className="col-lg-2 col-md-4 col-sm-6 colelement">
          <img className = "cardimg"  src={img4} onClick = {()=>click(cardnames[3])} alt="pic"/>
          <p className="cardtext">Cleaning Products</p>
         </div>
         <div className="col-lg-2 col-md-4 col-sm-6 colelement">
         <img className = "cardimg" src={img2} onClick = {()=>click(cardnames[1])} alt="pic"/>
